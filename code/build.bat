:: @echo off
g++ -o build/main src/hwinputs.cpp src/main.cpp -Wall -pedantic C:/glad-4.6/src/glad.c -IC:/glfw-3.4.bin.WIN64/include -IC:/glad-4.6/include -IC:/glm-1.0.1/include C:/glfw-3.4.bin.WIN64/lib-mingw-w64/libglfw3dll.a -lgdi32 -lopengl32
